"""
DeepSeek Tools Port - DeepSeek模型 Tool Calls 适配
"""
import json
...
class DeepSeekToolsPort:
    """DeepSeek模型Tool Calls专用接口"""
    ...
    def chat_with_tools(
        ...
        **kwargs
        ...
        Args:
            ...
            temperature: 温度参数
            thinking_level: 思考强度 (low/medium/high)
            stop_check: 停止检查函数
        ...
        """
        try:
            # DeepSeek使用标准流式,工具调用通过tool_calls字段返回
            params = {
                "model": model,
                "messages": messages,
